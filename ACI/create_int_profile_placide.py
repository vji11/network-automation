...
print "---------------------------------------------------------"
create_interface_policy_group_int('sr3pdfspe00-NET0', 'AEP_BAREMETAL', '10G_AUTO_ON', 'CDP_DISABLED', 'LLDP_ENABLED')
create_interface_policy_group_int('sr3pdfspe00-NET1', 'AEP_BAREMETAL', '10G_AUTO_ON', 'CDP_DISABLED', 'LLDP_ENABLED')
create_interface_policy_group_int('sr3pdfspe00-NET2', 'AEP_BAREMETAL', '10G_AUTO_ON', 'CDP_DISABLED', 'LLDP_ENABLED')
create_interface_policy_group_int('sr3pdfspe00-NET3', 'AEP_BAREMETAL', '10G_AUTO_ON', 'CDP_DISABLED', 'LLDP_ENABLED')
...
print "---------------------------------------------------------"
create_interface_switch_profile('sr3pdfspe00-NET0', '211', '211', '5', '5')
create_interface_switch_profile('sr3pdfspe00-NET1', '212', '212', '5', '5')
create_interface_switch_profile('sr3pdfspe00-NET2', '211', '211', '6', '6')
create_interface_switch_profile('sr3pdfspe00-NET3', '212', '212', '6', '6')
